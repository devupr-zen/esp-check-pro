...
const StudentAssessments = React.lazy(
	() => import("./pages/student/StudentAssessments"),
);
const StudentAssessmentDetail = React.lazy(
	() => import("./pages/student/StudentAssessmentDetail"),
);
const StudentActivities = React.lazy(
...
const TeacherAssessments = React.lazy(
	() => import("./pages/teacher/TeacherAssessments"),
);
const TeacherAssessmentNew = React.lazy(
	() => import("./pages/teacher/TeacherAssessmentNew"),
);
const TeacherAssignmentDetail = React.lazy(
	() => import("./pages/teacher/TeacherAssignmentDetail"),
);
const AssessmentAuthoring = React.lazy(
	() => import("./pages/teacher/AssessmentAuthoring"),
);
const TeacherLessons = React.lazy(
	() => import("./pages/teacher/TeacherLessons"),
);
const TeacherReports = React.lazy(
	() => import("./pages/teacher/TeacherReports"),
);
const TeacherBilling = React.lazy(
	() => import("./pages/teacher/TeacherBilling"),
);
const TeacherInvites = React.lazy(
	() => import("./pages/teacher/TeacherInvites"),
);

const RedeemInvite = React.lazy(() => import("./pages/redeem/RedeemInvite"));
const Settings = React.lazy(() => import("./pages/Settings"));
const AdminHub = React.lazy(() => import("./pages/admin"));
const SuperAdminOverview = React.lazy(
	() => import("./pages/superadmin/SuperAdminOverview"),
);
