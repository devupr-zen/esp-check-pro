...
import { Calendar, TrendingUp, Clock, Target, Play } from "lucide-react"
...
const recentActivities = [
  { title: "Business Writing Assessment", time: "2 hours ago", score: 85, status: "completed" },
  { title: "Email Communication Activity", time: "1 day ago", score: 92, status: "completed" },
  { title: "Presentation Skills", time: "3 days ago", score: 78, status: "completed" },
  { title: "Grammar Review", time: "1 week ago", score: 88, status: "completed" }
]
        ...
        <GlassCard className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              This month, focus on improving your professional email writing and presentation skills.
            </p>
            <ProgressBar 
              label="Progress" 
              value={65} 
          ...
          <div className="space-y-4">
            <div className="text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Ready for your next challenge?</p>
              </div>
            </div>
