			...
			<div className="p-6">
				<GlassCard className="p-6">
					...
					<div className="text-sm opacity-80 mt-1">
						{(assignmentErr as any)?.message ??
							"You may not have access to this assignment."}
					</div>
					<Button
						variant="secondary"
						className="mt-4"
	...
	return (
		<div className="p-6 space-y-4">
			...
			<GlassCard className="p-6 space-y-4">
				...
				<div className="text-sm opacity-80">
					Please complete this assessment. You can optionally attach a file
					(audio or document) and/or type a response.
				</div>
				...
				<div className="space-y-2">
					...
					<div className="flex gap-2 items-center">
						...
						<Button
							variant="outline"
							onClick={openFile}
							disabled={!submission?.submission_file_path}
						>
							Open file
						</Button>
					</div>
					{submission?.submission_file_path && (
						<div className="text-xs opacity-70">
							Saved: {submission.submission_file_path}
						</div>
					)}
				</div>
