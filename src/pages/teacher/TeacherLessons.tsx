		...
		<div className="space-y-6">
			...
			<GlassCard className="p-6">
				...
				<p className="text-muted-foreground">
					Plan monthly/weekly lessons and attach activities. This page is a
					placeholder to satisfy routing and navigation. It follows current UI
					conventions (MainLayout + GlassCard).
				</p>
			</GlassCard>
		</div>
	);
