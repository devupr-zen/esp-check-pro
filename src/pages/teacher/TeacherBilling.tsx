...
export default function TeacherBilling() {
  ...
  const getStatusColor = (status: string) => {
    return status === "Paid" ? "bg-primary/20 text-primary" : "bg-destructive/20 text-destructive";
  };
        ...
        <div className="lg:col-span-2">
          <GlassCard className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h4 className="text-2xl font-bold text-foreground">{subscriptionData.plan}</h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <div className="p-4 rounded-lg bg-primary/10">
                ...
                <p className="text-lg font-bold text-foreground">Up to {subscriptionData.students}</p>
              </div>
              <div className="p-4 rounded-lg bg-accent/10">
                ...
                <p className="text-lg font-bold text-foreground">{subscriptionData.assessments}</p>
              </div>
            </div>
