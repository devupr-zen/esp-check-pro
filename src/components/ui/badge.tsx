  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        neutral: "border-transparent bg-neutral text-muted-foreground shadow-sm",
        glass: "glass-card text-foreground border-white/30 shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
