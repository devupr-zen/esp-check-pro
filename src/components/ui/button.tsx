...
const buttonVariants = cva(
	"inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				default:
					"bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg shadow-lg hover:shadow-xl",
				destructive:
					"bg-destructive text-destructive-foreground hover:bg-destructive/90 rounded-lg shadow-lg",
				outline:
				...
				accent:
					"bg-accent text-accent-foreground hover:bg-accent/90 rounded-lg shadow-lg hover:shadow-xl",
				premium:
					"bg-gradient-to-r from-primary to-accent text-white hover:shadow-2xl hover:scale-[1.02] rounded-lg",
				...
				warning:
					"bg-warning text-warning-foreground hover:bg-warning/90 rounded-lg shadow-lg",
				success:
					"bg-success text-success-foreground hover:bg-success/90 rounded-lg shadow-lg",
			},
			size: {
